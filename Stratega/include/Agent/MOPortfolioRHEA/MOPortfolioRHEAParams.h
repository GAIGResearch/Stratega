...
namespace SGA {
	struct MOPortfolioRHEAParams {
		...
		LinearSumHeuristic HEURISTIC1{ LinearSumHeuristic() };	// the heuristic used to evaluate a genome
		MinimizeDistanceHeuristic HEURISTIC2{ MinimizeDistanceHeuristic() };	// the heuristic used to evaluate a genome
...
{
	template<>
	struct convert<SGA::MOPortfolioRHEAParams>
	{
		static bool decode(const Node& node, SGA::MOPortfolioRHEAParams& rhs)
		{
