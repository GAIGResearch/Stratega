...
namespace SGA
{
	void ForwardModel::advanceGameState(GameState& state, const Action& action) const
	{
	...
	void ForwardModel::endTurn(GameState& state) const
	{
	...
	std::vector<Action> ForwardModel::generateActions(GameState& state) const
	{
	...
	std::vector<Action> ForwardModel::generateActions(GameState& state, int playerID) const
	{
	...
	bool ForwardModel::checkGameIsFinished(GameState& state) const
	{
		if(state.gameType==GameType::TBS)
		{
	...
	void ForwardModel::advanceGameState(GameState& state, const RTSAction& action) const
	{
		moveEntities(state);
	...
	void ForwardModel::moveEntities(GameState& state) const
	{
	...
	void ForwardModel::resolveEntityCollisions(GameState& state) const
	{
	...
	void ForwardModel::resolveEnvironmentCollisions(GameState& state) const
	{
	...
	bool ForwardModel::buildNavMesh(GameState& state, NavigationConfig config) const
	{
	...
	Path ForwardModel::findPath(const GameState& state, Vector2f startPos, Vector2f endPos) const
	{
