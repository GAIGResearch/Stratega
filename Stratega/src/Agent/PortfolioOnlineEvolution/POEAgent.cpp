...
namespace SGA
{
    void POEAgent::runTBS(TBSGameCommunicator& gameCommunicator, TBSForwardModel forwardModel)
    {
    ...
    void POEAgent::initializePopulation(TBSForwardModel& forwardModel, TBSGameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    std::vector<POEGenome> POEAgent::shiftPopulation(TBSForwardModel& forwardModel, TBSGameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    void POEAgent::rheaLoop(TBSForwardModel& forwardModel, TBSGameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    std::vector<POEGenome> POEAgent::nextGeneration(TBSForwardModel& forwardModel, TBSGameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    POEGenome POEAgent::getNextGenerationIndividual(TBSForwardModel& forwardModel, TBSGameState& gameState, std::mt19937& randomGenerator)
    {
