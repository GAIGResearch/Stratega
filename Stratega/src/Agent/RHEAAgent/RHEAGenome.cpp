...
namespace SGA {
    ...
    RHEAGenome::RHEAGenome(ForwardModel& forwardModel, GameState gameState, RHEAParams& params)
    {
    ...
    void RHEAGenome::mutate(ForwardModel& forwardModel, GameState gameState, RHEAParams& params, std::mt19937& randomGenerator)
    {
        auto actionSpace = forwardModel.generateActions(gameState);
        const int playerID = gameState.currentPlayer;
    ...
    RHEAGenome RHEAGenome::crossover(ForwardModel& forwardModel, GameState gameState, RHEAParams& params, std::mt19937& randomGenerator, RHEAGenome& parent1, RHEAGenome& parent2)
    {
    ...
    void RHEAGenome::shift(ForwardModel& forwardModel, GameState gameState, RHEAParams& params)
    {
        const int playerID = gameState.currentPlayer;
