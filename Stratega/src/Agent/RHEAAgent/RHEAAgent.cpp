...
namespace SGA
{
	...
	void RHEAAgent::runTBS(AgentGameCommunicator& gameCommunicator, ForwardModel forwardModel)
	{
    ...
    void RHEAAgent::initializePopulation(ForwardModel& forwardModel, GameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    std::vector<RHEAGenome> RHEAAgent::shiftPopulation(ForwardModel& forwardModel, GameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    void RHEAAgent::rheaLoop(ForwardModel& forwardModel, GameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    std::vector<RHEAGenome> RHEAAgent::nextGeneration(ForwardModel& forwardModel, GameState& gameState, std::mt19937& randomGenerator)
    {
    ...
    RHEAGenome RHEAAgent::getNextGenerationIndividual(ForwardModel& forwardModel, GameState& gameState, std::mt19937& randomGenerator)
    {
