...
namespace SGA
{
	void DFSAgent::runAbstractTBS(AbstractTBSGameCommunicator& gameCommunicator, TBSAbstractForwardModel forwardModel)
	{
	...
	double DFSAgent::evaluateRollout(TBSAbstractForwardModel& forwardModel, TBSGameState2& gameState, int depth, const int playerID)
	{
	...
	void DFSAgent::applyActionToGameState(const TBSAbstractForwardModel& forwardModel, TBSGameState2& gameState, const Action& action)
	{
