...
namespace SGA {
	...
	double SimpleHeuristic::evaluateGameState(const TBSAbstractForwardModel& forwardModel, TBSGameState2& gameState, const int playerID)
	{
	...
	int SimpleHeuristic::score(const TBSAbstractForwardModel& forwardModel, TBSGameState2& gameState, int playerToScore) const
	{
	...
	double SimpleHeuristic::calculateGridVisiblePercentage(TBSGameState2& gameState) const
	{
