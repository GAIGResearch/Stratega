...
bool Sample_SoloMesh::handleBuild()
{
	...
	std::wstring map;
	map += L"FFFFFFFFFFFFFFFFFFFFFFFFF";
	map += L"F...................FFFFF";
	map += L"F.....................FFF";
	map += L"F................FF.....F";
	map += L"F..FF............FFFFF..F";
	...
	map += L"F..FF....FFFFFF.........F";
	map += L"F..FF....FFFFFF.........F";
	map += L"F..FFF...FFFFFF.........F";
	map += L"F..FFF...FFFFFF.........F";
	map += L"F..FF....FFFFFF.........F";
	map += L"F..FF....FFFFFF.....F...F";
	map += L"F..FF....FFFFFF.....F...F";
	map += L"F..FF....FFFFFF.........F";
	map += L"F..FFFF............F....F";
	map += L"F..FFFF.................F";
	map += L"F.......................F";
	map += L"F..FFFFFFFFFFFFFFFFFF...F";
	map += L"F..FFFFFFF...FFFFFFFF...F";
	map += L"F.......................F";
	map += L"FFFFFFFFFFFFFFFFFFFFFFFFF";
	...
	std::string mapp = converter.to_bytes(map);

	for (size_t x = 0; x < width; x++)
	{
		for (size_t y = 0; y < height; y++)
		{
			std::cout << mapp[y * width + x];
		}
		std::cout << std::endl;
	}
	...
	float m_meshBMax[3]{ width,100,height };
	...
	*/
	...
	float multiplier = (float)w / (float)width;
	int temp = 0;
	for (float x = 0; x < w; x++)
	{
		for (float y = 0; y < h; y++)
		{
			int charPos = ((std::ceil((y / multiplier)) * width) + std::ceil(x / multiplier));
			if (charPos < mapp.size()-1) {
				char c = mapp[charPos];
				if (c == 'F' || c == 'H' || c == 'M')
				{
					...
					rcAddSpan(m_ctx, *m_solid, x, y, 0, 5, RC_WALKABLE_AREA, 1);
			}
			else {
				temp++;
			}
	...
	//		{
	//			/*if (x + 1 < w && y + 1 < h) {
	//				rcAddSpan(m_ctx, *m_solid, x, y, 0, 5, 0, 1);
	//				rcAddSpan(m_ctx, *m_solid, x + 1, y, 0, 5, 0, 1);
	//				rcAddSpan(m_ctx, *m_solid, x + 1, y + 1, 0, 5, 0, 1);
	//				rcAddSpan(m_ctx, *m_solid, x, y + 1, 0, 5, 0, 1);
	//			}*/
	//			
	//		}
