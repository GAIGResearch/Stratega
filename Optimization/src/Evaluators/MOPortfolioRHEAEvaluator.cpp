...
namespace SGA
{
	...
	MOPortfolioRHEAEvaluator::MOPortfolioRHEAEvaluator(std::vector<int> popSizeCandidates,
	...
	) : Evaluator("MOPortfolioRHEAEvaluator"
	),
	...
	void MOPortfolioRHEAEvaluator::printPoint(const std::vector<int>& point)
    {
