...
int main(int argc, char** argv)
{
	...
	auto seed = parser.getCmdOption<unsigned int>("-seed", 4692271);
    ...
    //auto configPath = parser.getCmdOption< std::string >("-configPath", "../resources/gameConfigurations/TBS/ktk_elastic_rule.yaml");
	auto configPath = parser.getCmdOption< std::string >("-configPath", "../resources/gameConfigurations/TBS/Pusher_ungroup_mctsu.yaml");
