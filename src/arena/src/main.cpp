...
int main(int argc, char** argv)
{
    ...
    auto configPath = parser.getCmdOption< std::string >("-configPath", "../resources/gameConfigurations/TBS/ktk_randoms.yaml");
    ...
    auto mapsPath = parser.getCmdOption<std::string>("-mapsPath", "../resources/gameConfigurations/TBS/ktkMaps_30layouts_3.yaml");
