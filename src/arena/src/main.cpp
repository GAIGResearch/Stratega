...
int main(int argc, char** argv)
{
    ...
    auto configPath = parser.getCmdOption< std::string >("-configPath", "../resources/gameConfigurations/TBS/ktk_mcts_rule.yaml");
    ...
    auto mapsPath = parser.getCmdOption<std::string>("-mapsPath", "../resources/gameConfigurations/TBS/KtKMaps_test.yaml");
